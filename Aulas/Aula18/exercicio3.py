...
print(f'O preço do {lista[3][0]} é R$ {lista[0][2][0]}')
...
print(f'O preço do {lista[3][2]} é R$ {lista[4][1][2]}')

print('12: imprima o valor da uva')
print(f'O preço do {lista[1][3]} é R$ {lista[4][0][1]}')
...
print(f'O preço do {lista[1][-2]} é R$ {lista[4][0][-1]}')