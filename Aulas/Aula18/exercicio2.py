...
print(f'{lista[1][1]} - {lista[1][2]} - {lista[1][-2]} - {lista[1][-1]}')

print('4: imprima com f-string a seguinte sequência: alface lisa - salsinha - rucula - alface crespa')
print(f'{lista[2][1]} - {lista[2][-1]} - {lista[2][2]} - {lista[2][0]}')
...
print(f'{lista[0][0]}: {lista[1][2]} e {lista[1][-3]} - {lista[0][1]}: {lista[2][-2]} e {lista[2][2]} - {lista[0][2]}: {lista[3][1]}, {lista[3][-3]} e {lista[3][-2]}')

print('6: imprima com f-string a seguinte sequência: mamão - ervilha, rucula, salsinha, mamão, repolho')
print(f'{lista[1][0]} - {lista[3][1]}, {lista[2][2]}, {lista[2][-1]}, {lista[1][0]}, {lista[2][-2]}')

print('7: imprima com f-string a seguinte sequência: fruta: 3kg de laranja, 8kg de uva, 4.5kg de maçã, 1kg de vergamota')
print(f'{lista[0][0]}: 3kg de {lista[1][2]}, 8kg de {lista[1][3]}, 4.5kg de {lista[1][-2]}, 1kg de {lista[1][-1]}')
...
print(f'{lista[0][1]}: 5 maço de {lista[2][-1]}, 4 pés de {lista[2][0]} e {lista[2][1]}, 2 cabeças de {lista[2][-2]}')

print('9: imprima com f-string a seguinte sequência: legumes: 1kg de feijão, 2kg de gão de bico, 1.5 kg dde soja,'
      '1 pacote de ervilha')
print(f'{lista[0][2]}: 1kg de {lista[3][0]}, 2 kg de {lista[3][-2]}, 1.5 kg dde {lista[3][-1]}')
