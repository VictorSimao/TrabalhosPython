...
def list_dict(texto):
    ...
    for i in lista_texto:
        lista_dados = i.split(';')
        dict_pessoa = {'codigo':lista_dados[0],'nome':lista_dados[1],'idade':lista_dados[2],'sexo':lista_dados[3],'email':lista_dados[4],'telefone':lista_dados[5]}
        lista.append(dict_pessoa)
    return lista

lista = list_dict(texto)
