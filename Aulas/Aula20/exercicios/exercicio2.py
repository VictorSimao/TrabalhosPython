...
for linha in nota:
        if troco >= (linha['Nota(s)']):
                while troco >= (linha['Nota(s)']):
                        troco = troco - (linha['Nota(s)'])
                        dar_troco.append((linha['Nota(s)']))

for linha in moeda:
        if troco >= linha['Moeda(s)']:
                while troco >= linha['Moeda(s)']:
                        troco = troco - linha['Moeda(s)']
                        dar_troco.append(linha['Moeda(s)'])


for linha in dar_troco:
        print(linha)